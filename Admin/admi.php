       ...
       ?>
               ...
               <div class="row multi-columns-row">
                 <div class="col-md-4 col-sm-6 col-xs-12">
                   ...
                   <div align="left" margin="10px" height="33.33%">
                     <div class="content-box-image" style="height:200px;margin: 15px;background:green;border-radius: 25px;">
                       <h4>
                           <table>
                             <tr>
                               <td><h3 style="color:white">&nbsp;&nbsp;<b> PROFIT </b></h3></td>
                             </tr>
                             <tr>
                               <td><b><h6 style="color:white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total Balence</h6></b></td><td>
                             </tr>
                             <tr>
                               <td><b><h3 style="color:white">&nbsp;&nbsp; &#8377;<b><?php echo $tot_profit; ?> </b></h3></b></td>
             ...
             <table style="width:100%;margin:10px;" align="center">
               <tr align="center" style="border: 1px solid black;">
                 ...
                 <td style="border: 1px solid black;"><b>Shop<b></td>
                 <td style="border: 1px solid black;"><b>Delivery<b></td>
                 <td style="border: 1px solid black;"><b>Profit</b></td>
               </tr>
             <?php
             $oid=mysqli_query($conn,"SELECT * FROM order_delivery ");
             while($oidf=mysqli_fetch_array($oid)){
              ...
              // $count=1;
               ...
               <tr align="center" style="border: 1px solid black;">
                 ...
                 <td style="border: 1px solid black;"><?php echo $bal; ?></td>
                 <td style="border: 1px solid black;"><?php echo $delchrg; ?></td>
                 <td style="border: 1px solid black;"><b><?php echo $profit; ?></b></td>
               </tr>
