...
<html lang="en" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60" style="background-repeat: no-repeat;
    ...
    <span class="login100-form-title p-b-53 fnt">
      <h1 align="center"><b>Edit Item Here</b></h1>
      <h4>
    <form action="edit_update.php" method="POST">
      <table align="center" class="dat">
        ...
        <tr>
          <td>&nbsp;&nbsp;Price  </td>
          <td><div data-validate = "price is required">
            <input type="text" name="Price" style="border-radius: 10px;background-color:#ffa880;border:none;" >
          </div></td>
        </tr>
      </table><br>
      <div align="center">
        <input type="submit" name="edit" value="Submit" style="border-radius: 8px;background-color:black;border:none;color:white;">
      </div>
      </form>
      </h4>
      </span>
